    ...
    <section className="py-8 my-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          {/* Tag Filter Sidebar */}
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-100 p-4 sm:p-6 shadow-xs">
            <h4 className="text-xs font-extrabold text-slate-400 uppercase tracking-widest mb-3 sm:mb-4 flex items-center space-x-1.5">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              <button
                ...
                className={`px-3 py-2 rounded-xl text-xs font-semibold transition-all cursor-pointer active:scale-95 min-h-[38px] flex items-center ${
                  selectedTag === null
                    ? 'bg-city-blue text-white shadow-xs'
